print('Введите сумму рублей которую ван нужно вывести в виде текста.')  # Сообщение для пользователя
try:
    num = int(input('Введите целое число от 1 до 9999: '))    # Ввод значений
    ...
    if 10000 > num > 0:     # Проверка на значение
        # Разбитие на цифры
        a1 = num // 1000
        a2 = (num // 100) % 10
        a3 = (num // 10) % 10
